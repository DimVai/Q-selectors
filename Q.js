...
Q.methods = {
    ...
    on(event,callback,debounceRate=null) {        
        if (!debounceRate){
            ...
            return this;
        } else if (debounceRate>10){ // debounce only works on named (external) functions with no arguments
...
Q.eachProxy = (Qarray) => {
    // προσοχή, το each επηρεάζει το fetch με html (όχι με set), 
    return new Proxy(Qarray, {            
        get(o,property){
